...
class EstadoempleadoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Estadoempleado'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->idestadoempleado));
		}
	 ...
	 * @return Estadoempleado the loaded model
	 ...
	 * @param Estadoempleado $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='estadoempleado-form')
		{
