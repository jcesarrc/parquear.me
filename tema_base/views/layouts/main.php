            ...
            <div id="aqua-header">
                <div class="aqua-container">
                    <a href="<?php echo Yii::app()->baseUrl; ?>/" class="aqua-well-mini">
                        <h1 class="aqua-slogan">AquaBlue - CMS Admin Theme</h1>
                        <h2 class="aqua-slogan">Fast and Elegant Admin Theme</h2>
                    </a>
                ...
                <div class="aqua-container">
                    ...
                    $this->widget('bootstrap.widgets.TbMenu', array(
                        ...
                        'items' => array(
                            ...
                            array('label' => 'Guide tour', 'url' => "#", 'icon' => 'play-circle white margin', 'itemOptions' => array('onclick' => 'guiders.show("1")')),
